 ...
 * Na verdade pronto mencionado nos tutoriais
 * 
 * Os dois middlewares acima lidam apenas com dados json e codificação de url (x-www-form-urlencoded)
 * Então, precisamos adicionar middleware extra para lidar com dados de formulário
 * Aqui podemos usar expresso - upload de arquivo
 */
app.use(fileUpload({
  debug: false
}));
...
app.get('/user', function(req, res) {
  var idSes = req.params.idCliente
...
app.post('/send-message', [
  ...
  /**
   * Verifique se o número já está cadastrado
   * Copiado de app.js
   * 
   * Verifique app.js para mais exemplos de validações
